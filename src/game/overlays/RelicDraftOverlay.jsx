...
export default function RelicDraftOverlay() {
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', background: 'rgba(0,0,0,0.93)', zIndex: 200, display: 'flex', justifyContent: 'center', alignItems: 'center', padding: 16, backdropFilter: 'blur(8px)' }}>
      <div className="fw-scaleIn" style={{ background: 'linear-gradient(135deg,#1a1030,#2d1a4a)', borderRadius: 14, maxWidth: 380, width: '100%', border: `1px solid ${T.purple}40`, padding: 20 }}>
        <div style={{ textAlign: 'center', marginBottom: 14 }}>
          <div style={{ fontFamily: T.fontPixel, fontWeight: 700, fontSize: 18, color: T.purple, textTransform: 'uppercase', letterSpacing: 1 }}>📿 Elige Reliquia</div>
              ...
              <div key={i} onClick={() => {
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', gap: 6, alignItems: 'center', marginBottom: 2 }}>
                    ...
                    <span style={{ fontFamily: "'Oswald'", fontSize: 11, color: rarityColor, background: `${rarityColor}15`, padding: '2px 6px', borderRadius: 3, textTransform: 'uppercase', letterSpacing: 0.5 }}>{relic.rarity}</span>
                  </div>
