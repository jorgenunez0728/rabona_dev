...
export const ACHIEVEMENTS=[
  ...
  // ── Gameplay Positivo ──
  {id:'goleada',n:'Goleada',d:'Gana un partido 5-0 o más',i:'💪',check:g=>g.hadGoleada},
  {id:'invicto',n:'Invicto',d:'Completa una liga sin perder',i:'🛡',check:g=>g.hadUndefeatedLeague},
  {id:'remontada',n:'Remontada Épica',d:'Gana después de ir perdiendo 0-2',i:'🔄',check:g=>g.hadRemontada},
  {id:'clean5',n:'Portero de Hierro',d:'5 porterías a cero seguidas',i:'🧤',check:g=>g.hadCleanStreak5},
  {id:'gol_90',n:'Último Suspiro',d:'Gol ganador después del minuto 85',i:'⏱',check:g=>g.hadLastMinuteWinner},
  {id:'hat_trick',n:'Hat Trick',d:'Un jugador anota 3+ goles en un partido',i:'🎩',check:g=>g.hadHatTrick},
  {id:'runs20',n:'Leyenda Viviente',d:'Completa 20 carreras',i:'🏅',check:g=>g.totalRuns>=20},
  {id:'goals500',n:'Leyenda Goleadora',d:'Anota 500 goles totales',i:'⚽',check:g=>g.totalGoals>=500},
  // ── Gameplay Negativo ──
  {id:'racha_negra',n:'Racha Negra',d:'Pierde 3 partidos seguidos',i:'💀',check:g=>g.hadLoseStreak3},
  {id:'humillacion',n:'Humillación',d:'Pierde un partido 0-5 o peor',i:'😭',check:g=>g.hadHumillacion},
  {id:'sin_gol_3',n:'Mala Suerte',d:'Pierde 0-1 tres veces en un run',i:'😤',check:g=>g.hadNarrowLosses3},
  {id:'final_perdida',n:'Tan Cerca...',d:'Pierde la final de la Liga Intergaláctica',i:'💔',check:g=>g.hadLostFinal},
  {id:'descenso_epico',n:'Caída Libre',d:'Muere en la primera liga (Barrio)',i:'📉',check:g=>g.hadDiedInBarrio},
  {id:'bancarrota',n:'Bancarrota',d:'Llega a 0 monedas',i:'💸',check:g=>g.hadBancarrota},
  {id:'lesion_masiva',n:'Enfermería Llena',d:'Ten 3+ jugadores lesionados a la vez',i:'🏥',check:g=>g.hadMassInjury},
  {id:'abandono',n:'Cobarde',d:'Abandona un run',i:'🚪',check:g=>(g.runsHistory||[]).some(r=>r.endType==='abandoned')},
  // ── Economía ──
  {id:'tacano',n:'Tacaño',d:'Termina un run con 100+ monedas sin gastar',i:'🏦',check:g=>g.hadTacano},
  {id:'comerciante',n:'Comerciante',d:'10+ transacciones en un run',i:'🤝',check:g=>g.hadComerciante},
  // ── Secretos / Meta ──
  {id:'el_94',n:'El Run del 94',d:'Gana Intergaláctica con Don Miguel',i:'👴',check:g=>(g.runsHistory||[]).some(r=>r.endType==='champion'&&r.coachId==='miguel')},
  {id:'maldito_triple',n:'Triple Maldición',d:'Ten 3 maldiciones activas a la vez',i:'☠️',check:g=>(g.maxSimultaneousCurses||0)>=3},
  {id:'maestro_oscuro',n:'Maestro Oscuro',d:'Domina las 6 maldiciones',i:'🌑',check:g=>{const p=g.curseMasteryProgress||{};const IDS=['prensa_hostil','lesion_cronica','deuda','nemesis','fatiga_mental','escandalo'];return IDS.every(id=>(p[id]||0)>=3);}},
  {id:'no_mercado',n:'Puro Barrio',d:'Gana una liga sin comprar jugadores',i:'🏘',check:g=>g.hadNoMarketWin},
  {id:'one_man_army',n:'One Man Army',d:'Un jugador anota 80%+ de los goles',i:'🦸',check:g=>g.hadOneManArmy},
  {id:'mutador_total',n:'Masoquista',d:'Gana con 3 mutadores activos',i:'🔥',check:g=>(g.runsHistory||[]).some(r=>r.endType==='champion'&&(r.activeMutators||[]).length>=3)},
  {id:'speedrun',n:'Speedrunner',d:'Asciende en 8 partidos o menos',i:'⚡',check:g=>g.hadSpeedrun},
  // ── Maestría de Arquetipos ──
  {id:'filosofo',n:'Filósofo',d:'Juega con los 6 arquetipos',i:'🎭',check:g=>{const ids=new Set((g.runsHistory||[]).map(r=>r.archetypeId).filter(Boolean));return ids.size>=6;}},
  {id:'caudillo_master',n:'Caudillo Supremo',d:'Gana Intergaláctica como Caudillo',i:'🦅',check:g=>g.archetypeWins?.caudillo},
  {id:'arquitecto_master',n:'Arquitecto Supremo',d:'Gana Intergaláctica como Arquitecto',i:'📐',check:g=>g.archetypeWins?.arquitecto},
  {id:'mercenario_master',n:'Mercenario Supremo',d:'Gana Intergaláctica como Mercenario',i:'💰',check:g=>g.archetypeWins?.mercenario},
  {id:'mistico_master',n:'Místico Supremo',d:'Gana Intergaláctica como Místico',i:'🔮',check:g=>g.archetypeWins?.mistico},
  {id:'cantera_master',n:'Cantera Suprema',d:'Gana Intergaláctica como Cantera',i:'🌱',check:g=>g.archetypeWins?.cantera},
  {id:'apostador_master',n:'Apostador Supremo',d:'Gana Intergaláctica como Apostador',i:'🎲',check:g=>g.archetypeWins?.apostador},
  // ── Colección / Progresión ──
  {id:'hall_full',n:'Panteón Completo',d:'Llena el Hall of Fame (20)',i:'🏛',check:g=>(g.hallOfFame||[]).length>=20},
  {id:'arbol_completo',n:'Árbol Completo',d:'Desbloquea todo el Legacy Tree',i:'🌳',check:g=>(g.legacyUnlocks||[]).length>=18},
  {id:'todas_cartas',n:'Coleccionista Total',d:'Colecciona las 28 cartas',i:'🎴',check:g=>(g.cardCollection||[]).length>=28},
];
