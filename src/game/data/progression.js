...
export const LEGACY_BRANCHES = ['scouting','cantera','sponsor','tactics','charisma'];
...
export function calcLegacyPoints(gs) {
  ...
  return fromRuns + fromAchievements + fromAscension;
}
...
// ── Curses: negative effects that persist during a run ──
export const CURSES = [
  { id:'prensa_hostil', n:'Prensa Hostil',       i:'📰', d:'-5 química por 3 partidos.',               duration:3, fx:'chem_penalty',   val:-5 },
  { id:'lesion_cronica',n:'Lesión Crónica',       i:'🩼', d:'Un jugador aleatorio pierde -1 en un stat.',duration:0, fx:'stat_loss',      val:-1 },
  { id:'deuda',         n:'Deuda con el Barrio',  i:'💸', d:'-10 monedas por jornada hasta pagar.',      duration:5, fx:'coin_drain',     val:-10 },
  { id:'nemesis',       n:'Némesis',              i:'😈', d:'Un rival específico se vuelve +3 más fuerte.',duration:0,fx:'rival_boost',    val:3 },
  { id:'fatiga_mental', n:'Fatiga Mental',        i:'😰', d:'Moral máxima reducida a 70 por 4 partidos.', duration:4, fx:'morale_cap',    val:70 },
  { id:'escandalo',     n:'Escándalo Mediático',  i:'📺', d:'Sin board events positivos por 3 partidos.', duration:3, fx:'no_good_events',val:0 },
];

// ── Player Archetypes: unique passive abilities (unlockable via legacy/achievements) ──
